...
TEMPLATEFILE=../templates/eventListener.yaml
...
sed -i "s|/home/ec2-user/managedblockchain-tls-chain.pem|/usr/src/app/certs/managedblockchain-tls-chain.pem|g" ../listener/src/connection-profile.yaml
...
docker build -t $CHAINCODE/fabric-event-listener .
